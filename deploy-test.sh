...
${AGENT_TEST_HOME}/.autotest/agent-test.sh --max-running-size 4 --branch "$AGENT_BRANCH_NAME" -r "$AGENT_GIT_URL" --reportFileMode ${REPORT_FILE_MODE} --testcase-branch "$TESTCASE_BRANCH"
