...
export AGENT_FILE_PATH=/usr/local/jettyclient-scenario/agent
...
java $OKHTTP_SCENARIO_OPTS -jar /usr/local/skywalking-jettyclient-scenario/jettyclient-scenario.jar
