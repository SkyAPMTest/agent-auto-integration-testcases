...
export AGENT_FILE_PATH=/usr/local/resteasy-server1/agent
...
RESTEASY_PORT=${RESTEASY_PORT} java $SCENARIO_OPTS -jar /usr/local/resteasy-server1/resteasy-server1.jar